...
В качестве второго примера можно взять сайт вакансий Работа.ру[<sup>[3]</sup>](#source_3).  Это сайт вакансий для специалистов средней квалификации в России. Основная ориентация портала «Работа» - сотрудники «среднего звена». Этот ресурс подойдет для поиска работы:
1. Студентам
2. Людям без опыта
3. На подработку
4. На отдалённой вахте
