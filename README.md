...
В настоящее время существует большое количество бюро трудоустройсва, которыми пользуются миллионы людей. Одним из наиболее[<sup>[1]</sup>](#source_1) популярных является HeadHunter[<sup>[2]</sup>](#source_2) (Hh.ru), Первое время здесь предлагалась работа только профессионалам, высококвалифицированным сотрудникам. Однако потом политика «Хэдхантер» изменилась. Потому что возросла его аудитория. Сейчас на площадке много вакансий для студентов и неквалифицированных специалистов. Работа предлагается в разных направлениях и по всей России. Все предложения проходят проверку модераторов. Недостатком hh.ru можно назвать высокую стоимость услуг для работодателей.
...
Функция не выводит информации о резюме с введенным ID, следовательно функция Delete сработала корректно.
<a name="conclusion"> </a>
